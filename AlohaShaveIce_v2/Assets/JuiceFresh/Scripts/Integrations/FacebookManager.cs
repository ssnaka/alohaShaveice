...
public class FacebookManager : MonoBehaviour {
	...
	public void AddFriend (FriendData friend) { //1.4.4
	...
	public void SetPicture (string userID, Sprite sprite) {//1.4.4
		FriendData friendIndex = FacebookManager.Friends.Find (delegate (FriendData bk) {
	...
	public void LoggedSuccefull () {//1.4.4
